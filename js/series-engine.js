...
(function() {
  ...
  class SeriesEngine {
    ...
    // from the number that sizes the next escalated bet. With the Final-N
    // zero-exclusion (0/00 never enter finalEight), this is finalEight
    // itself — the filter is kept as a belt-and-suspenders guard.
