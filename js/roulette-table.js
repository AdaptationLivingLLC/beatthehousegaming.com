  ...
  class RouletteTableUI {
    ...
    _updateNumbers() {
      ...
      for (const num of this.engine.numbers) {
        ...
        // Final 8 highlight (D1/rule 12) — _isFinalHighlighted also lights
        // 0/00 during the closing phase. Kept in a local so the next-best
        // and cold-tint checks below reuse it; dropping this local was the
        // boot bug that threw on every render (undefined inFinal).
        const inFinal = this._isFinalHighlighted(num.value);
